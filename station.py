...
#             total_icao = len([k for k in stations if k.isalpha()])
#             print(f"Total stasiun BMKG: {total_icao}")

#             # contoh lookup
#             print("Cek ICAO WIII:", stations.get("WIII"))
#             print("Cek WMO 97180:", stations.get("97180"))
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # ambil 5 sampel stasiun (key ICAO)
        icao_keys = [k for k in stations if k.isalpha()][:5]
        print("5 Sampel Stasiun BMKG:")
        for icao in icao_keys:
            print(stations[icao])
